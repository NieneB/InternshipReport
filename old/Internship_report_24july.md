...
A small test will be held to see if the product complies with the set requirements and objectives of overall sub-objective 1. 
...
2 I feel tempted to explore more about the field-names in the application.
3 I feel tempted to use this application multiple times.

4 The meaning and origin of the field-names are clear to me. 
5 The stories and information is surprising and enriched my knowledge.
6 I understand the field-names and their importance.

7 The application is intuitive and simple to use.
...
- rasterize water with cell size 5
- subtract from AhN with raster calculator
...
## Sub-objective 2. The prototype web application
The web application can be found on: $$$$$
Some screen shots of how it looks:
...
<p class="fig">Map functionalities with mouse over. </p>
...
<p class="fig">Map drawing a line function </p>
...
## Sub-objective 3. Evaluating the web-application according to the requirements.
...
Question 8 got the lowest score, the functionality did not work as the user woul## Theoretical framework
First, a literature research is done into geo visualization techniques and already available methods which are applicable to the field-names. Describing the field-name data in the kind of data it is and the visual variables which can be linked to them. This to cover objective 1a, to make the application attractive, and 2c, understanding the geo-data. 
